...
if __name__ == '__main__':
    sp1, sr1 = [1, 3, 2], ["diamond", "diamond", "diamond", "iron", "iron", "diamond", "iron", "stone"]
    sp2, sr2 = [0, 1, 1], ["diamond", "diamond", "diamond", "diamond", "diamond", "iron", "iron", "iron", "iron", "iron", "diamond"]
    print(solution(sp2, sr2))
